...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions):
        ...
        conv1 = _conv_bn_relu(filters=64, kernel_size=(7, 7), strides=(2, 2))(image_input)
        ...
        x = Dense(512,kernel_initializer="glorot_normal",
                      activation="relu")(flatten1)
        x = Dense(512,kernel_initializer="glorot_normal",
                      activation="relu")(x)
        print("x",x)
        speed_input = Input(shape=(1,))
        speed = Dense(128,kernel_initializer="glorot_normal",
                      activation="relu")(speed_input)
        speed = Dense(128,kernel_initializer="glorot_normal",
                      activation="relu")(speed)
        print("speed",speed)
        joint = Concatenate(axis=1)([x,speed])
        
        joint = Dense(512,kernel_initializer="glorot_normal",
